...
\begin{tikzpicture}[
  ...
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,6.0) {算};
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,5.75) {死};
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,5.5) {草};
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,5.25) {劇};
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,5.0) {本};
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,4.75) {全};
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,4.5) {文};
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,4.25) {\jcz{}};
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,4.0) {\jcz{}};
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,3.75) {\jcz{}};
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,3.5) {註};
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,3.25) {音};




  % Cover art: centered on front panel
  \node[anchor=center, inner sep=0] at (9.373,5) {\includegraphics[width=4in]{../pics/lawyer-lawyer-bw-final.jpg}};

  % Title line below image (front panel): 食神劇本全文 + Jyutcitzi + 註音
  \node[anchor=center, font=\Large\bfseries, black, align=center] at (9.373,1.5) {\jcz{}算死草劇本全文註音};

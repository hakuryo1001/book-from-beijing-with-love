...
\begin{tikzpicture}[
  ...
  % 7) Spine: title vertically stacked, top to bottom (y descends)
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,5.5) {食};
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,5.25) {神};
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,5.0) {劇};
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,4.75) {本};
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,4.5) {全};
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,4.25) {文};
  ...
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,3.25) {註};
  \node[anchor=center, font=\scriptsize\sffamily, black, align=center] at (6.249,3.0) {音};




  % Cover art: centered on front panel
  \node[anchor=center, inner sep=0] at (9.373,4.5) {\includegraphics[width=4in]{../pics/god-of-cookery-final.png}};
